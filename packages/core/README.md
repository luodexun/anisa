...
@luodexun/core/0.0.1 darwin-x64 node-v12.13.1
$ core --help [COMMAND]
USAGE
  $ core COMMAND
...
...
_See code: [src/commands/core/start.ts](https://github.com/luodexun/core.git/core/blob/v0.0.1/src/commands/core/start.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/luodexun/core.git/core/blob/v0.0.1/src/commands/hello.ts)_
