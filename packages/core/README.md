...
@luodexun/core/0.0.22 darwin-x64 node-v12.13.1
$ core --help [COMMAND]
USAGE
  $ core COMMAND
...
...
_See code: [src/commands/command.ts](https://github.com/luodexun/anisa/blob/v0.0.22/src/commands/command.ts)_
...
_See code: [src/commands/core/debug.ts](https://github.com/luodexun/anisa/blob/v0.0.22/src/commands/core/debug.ts)_
...
_See code: [src/commands/core/start.ts](https://github.com/luodexun/anisa/blob/v0.0.22/src/commands/core/start.ts)_
