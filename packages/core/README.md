...
_See code: [src/commands/core/start.ts](https://github.com/luodexun/anisa/blob/v0.0.9/src/commands/core/start.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/luodexun/anisa/blob/v0.0.9/src/commands/hello.ts)_
